...
const PLANNED: readonly PlannedItem[] = [
  {
    title: 'Webhooks',
    icon: Icons.bolt,
    body: 'Signed event notices to your URL. Never post content.'
  },
  {
    title: 'MCP server for AI agents',
    icon: Icons.sparkles,
    body: 'Let your AI assistant read, draft and propose schedules.'
  },
  {
    title: 'Automation apps',
    icon: Icons.link,
    body: 'An official app for automation tools. Use tokens meanwhile.'
  },
  {
    title: 'Desktop companion',
    icon: Icons.laptop,
    body: 'Publish from your own computer.'
  }
];
...
export function NotYetCard() {
  return (
    ...
    >
      <ul className='grid gap-x-6 gap-y-4 @lg:grid-cols-2 @3xl:grid-cols-4'>
        {PLANNED.map((item) => (
