...
/**
 * PostRiff: the radio pattern's keyboard model. Arrow keys move to the next or
 * previous enabled option and select it; only the selected option is a Tab stop.
 */
function moveRadioSelection(event: KeyboardEvent<HTMLDivElement>) {
...
export function RadioGroupItem({
  ...
  return (
    ...
    >
      ...
      {label && description ? (
        <span className={cn('flex min-w-0 select-none flex-col gap-0.5', disabled && 'opacity-60')}>
