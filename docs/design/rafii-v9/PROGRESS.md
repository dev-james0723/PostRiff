...
- 2026-09-24 about 19:24 UTC: migration 019 was applied and verified in production with the same isolated method, with no redeploy. The cron's operations snapshot is back to `ok`. 016 is held for a decision to launch API tokens (`migrations-review.md`).
