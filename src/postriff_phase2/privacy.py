...
SUBPROCESSORS = [
    ...
    {"name": "Social providers (LinkedIn, Threads, Instagram, Bluesky, Mastodon, X, Discord, Telegram, Facebook, YouTube, TikTok, Pinterest)", "purpose": "publishing and metrics for accounts the customer connects", "status": "connected only by the customer's own OAuth grant"},
